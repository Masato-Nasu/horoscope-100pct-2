🌟 100% 星占い 2
<p align="center"> <img src="icon-512.png" width="160" alt="100% HOROSCOPE icon" /> </p>

100% 星占い 2 は、初代「100% 星占い」をベースに、
太陽・月 + 水星〜土星までをまとめて角度解析する「角度モード専用」版です。
...
<p align="center"> <img src="screenshot1.png" alt="入力画面のスクリーンショット" width="420"> </p>

結果画面

<p align="center"> <img src="screenshot2.png" alt="結果画面のスクリーンショット" width="420"> </p>
🔮 特長（2版のポイント）
